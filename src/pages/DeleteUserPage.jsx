  ...
  return (
    <div className="card space-y-3">
      ...
      <div className="flex items-center gap-2">
        <input value={userId} onChange={(e) => setUserId(e.target.value)} placeholder="User ID" className="form-input w-40" />
        <button onClick={openModal} className="btn-danger">Delete</button>
      </div>
      {user && (
